...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div class="container">
            ...
            <h1 class="display-3">Sports & Fitness</h1>
            <p class="lead">We have a variety of sports & fitness programmes for you to choose from!</p>
            </header>
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"> - Earn 4 Points - </h5>
