    ...
    <body id="page-top">
        ...
        <div class="container">
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                ...
                <img class="card-img-top" src="https://specials-images.forbesimg.com/imageserve/935844038/960x0.jpg?fit=scale" alt="">
                <div class="card-body">
                    <h4 class="card-title">Origami</h4>
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                <div class="card h-100">
                <img class="card-img-top" src="https://cdn.shopify.com/s/files/1/0879/9814/products/IMG_7974_e2760337-430a-496a-9baa-ea88d0402732_1050x.jpg?v=1583908854" alt="">
                <div class="card-body">
                    <h4 class="card-title">Floral design</h4>
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                ...
                <div class="card-body">
                    <h4 class="card-title">Pottery Class</h4>
                    <h5 class="card-title"> - Earn 2 Points - </h5>
