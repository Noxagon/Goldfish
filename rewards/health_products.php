        ...
        <div class="container">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    <a href="health_products.php" class="list-group-item" style="background-color: lightgray;"><h5>Health & Wellcare</h5></a>
                    <a href="home_products.php" class="list-group-item"><h5>Home & Lifestyle</h5></a>
                </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="#">BRAND's Essence of Chicken 6s x 68ml</a>
                        </h4>
                        <h5>15 Points</h5>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="#">NH NUTRI GRAINS Instant Multimix Grain 1kg</a>
                        </h4>
                        <h5>20 Points</h5>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="#">CALTRATE Plus Minerals 100 Tablets</a>
                        </h4>
                        <h5>25 Points</h5>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="#">NUTRILIFE Immune C Vitamin C + Resveratrol 60 Caps</a>
                        </h4>
                        <h5>40 Points</h5>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="#">PRINCIPLE NUTRITION PLUS Plus Senior Complete Multi Vitamins 150 Tablets</a>
                        </h4>
                        <h5>20 Points</h5>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="#">VITAREALM Hyper Strength Omega3 Alaska Tuna Fish Oil 100 Capsules </a>
                        </h4>
                        <h5>50 Points</h5>
