        ...
        <div class="container">
            ...
            <div class="col-lg-9">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?category=HL&id=0">Dyson Pure Cool™ air purifier tower fan</a>
                        </h4>
                        <h5>200 Points</h5>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?category=HL&id=1">OSIM uDivine V Massage Chair</a>
                        </h4>
                        <h5>500 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?category=HL&id=2">Russell Taylors 6L Electric Pressure Cooker</a>
                        </h4>
                        <h5>60 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?category=HL&id=3">Xiaomi Deerma Water Spray Mop Dust Cleaner</a>
                        </h4>
                        <h5>20 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?category=HL&id=4">XIAOMI MIJIA Robot Vacuum Cleaner</a>
                        </h4>
                        <h5>250 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?category=HL&id=5">Philips Daily Collection Coffee maker</a>
                        </h4>
                        <h5>35 Points</h5>
                    </div>
                    <div class="card-footer">
