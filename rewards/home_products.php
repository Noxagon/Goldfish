        ...
        <div class="container">
            ...
            <div class="col-lg-9">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <img class="d-block img-fluid" src="https://www.willadsenfamily.org/wp-content/uploads/2019/07/Cooker_banner.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block img-fluid" src="https://www.vanillaluxury.sg/sites/default/files/field/image/banner_136.png" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block img-fluid" src="https://www.watsons.com.sg/medias/WS-1005x420px-banner-04.jpg?context=bWFzdGVyfHJvb3R8MTEzODUyfGltYWdlL2pwZWd8aDk0L2hmZS84OTQ4ODI2NDcyNDc4LmpwZ3xmMmQxNzY2ZGYwZGFlY2M0NGI4NWU4ZjUzYTYwOTVkOTc0OWJmNzcwYWNmMWQxY2ZjNjM2YmZiZTg5NjYyOTJl" alt="Third slide">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <a href="#"><img class="card-img-top" src="https://firebasestorage.googleapis.com/v0/b/gold-b1fea.appspot.com/o/home%2Ffan.png?alt=media&token=0aa58e7a-af24-4cad-b559-6774c72cde0a" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?id=HL0">Dyson Pure Cool™ air purifier tower fan</a>
                        </h4>
                        <h5>200 Points</h5>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="https://firebasestorage.googleapis.com/v0/b/gold-b1fea.appspot.com/o/home%2Fosim.jpg?alt=media&token=9e96a401-68e2-47ce-bd21-a4167376e9a7" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?id=HL1">OSIM uDivine V Massage Chair</a>
                        </h4>
                        <h5>500 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?id=HL2">Russell Taylors 6L Electric Pressure Cooker</a>
                        </h4>
                        <h5>60 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?id=HL3">Xiaomi Deerma Water Spray Mop Dust Cleaner</a>
                        </h4>
                        <h5>20 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?id=HL4">XIAOMI MIJIA Robot Vacuum Cleaner</a>
                        </h4>
                        <h5>250 Points</h5>
                    </div>
                    <div class="card-footer">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                        <a href="products_info.php?id=HL5">Philips Daily Collection Coffee maker</a>
                        </h4>
                        <h5>35 Points</h5>
                    </div>
                    <div class="card-footer">
